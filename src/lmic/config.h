...
# ifndef VIM3
# define LMIC_FAILURE_TO_PRINT Serial.print
# define LMIC_FAILURE_TO_FLUSH Serial.flush();
# else
# define LMIC_FAILURE_TO_PRINT printf
# define LMIC_FAILURE_TO_FLUSH fflush(stdout);
# endif
#endif
