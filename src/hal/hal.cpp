...
//    fprintf("nss: "); Serial.println(plmic_pins->nss);
//    fprintf("rst: "); Serial.println(plmic_pins->rst);
//    fprintf("dio[0]: "); Serial.println(plmic_pins->dio[0]);
//    fprintf("dio[1]: "); Serial.println(plmic_pins->dio[1]);
...
#if !defined(LMIC_USE_INTERRUPTS) or defined(VIM3)
...
void hal_failed (const char *file, u2_t line) {
    ...
    LMIC_FAILURE_TO_PRINT("FAILURE \n");
    LMIC_FAILURE_TO_PRINT(file);
    LMIC_FAILURE_TO_PRINT(':');
    LMIC_FAILURE_TO_PRINT(line);
    LMIC_FAILURE_TO_PRINT("\n");
    LMIC_FAILURE_TO_FLUSH
#endif
